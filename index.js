module.exports = {
  ...
  'rules': {
    ...
    'comma-style': [2, 'last'],
    // Does not allow spacing inside object property accessors: `obj[ a ]` is incorrect
    ...
    'no-else-return': 2,
    'no-extra-label': 2,
    // Must prefix all floats with `0` if it is a decimal property: `.15` is incorrect
    'no-floating-decimal': 2,
    // Must convert value types explicitly: use `String(foo)` instead of `"" + foo'
